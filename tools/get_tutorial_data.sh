...
wget --load-cookies=$cookief https://cdcvs.fnal.gov/redmine/attachments/66046/tutorial_first_demo_v2_5_Data.zip -O tutorial_${TUTORIAL}_${VERSION}_Data.zip --no-check-certificate

...
if [[ ${opt_develop:-0} -eq 1 ]];then
	...
	# spack mpd new-project --force -y --name ots-develop -E ots-${demo_version} cxxstd=20 %gcc@13.3.0 generator=ninja # Upstream
	spack mpd new-project --force -y --name ots-develop -E ots-${demo_version} cxxstd=20 %gcc@13.3.0 # Fork

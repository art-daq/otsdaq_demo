...
int main(int argc, char** argv) {
  ...
  std::string supervisorConfigurationPath_ = "/" + supervisorContextUID_ + "/LinkToApplicationConfiguration/" +
  ...
  std::pair<std::string, ConfigurationGroupKey> theGroup(configurationGroupName,
                                                         ConfigurationGroupKey(configurationKeyValue_));
  ...
  FEOtsUDPTemplateInterface* theInterface_ = new FEOtsUDPTemplateInterface(
      ...
      supervisorConfigurationPath_ + "/LinkToFEInterfaceTable/" + interfaceUID_ + "/LinkToFETypeConfiguration");

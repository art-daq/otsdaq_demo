...
class FEOtsEthernetProgramInterface
    : public FEOtsUDPTemplateInterface  // public FEVInterface, public OtsUDPHardware, public OtsUDPFirmwareDataGen
{
 public:
  // FEOtsEthernetProgramInterface     (unsigned int name=0, std::string daqHardwareType="daqHardwareType",
  // std::string firmwareType="firmwareType", const FEInterfaceConfigurationBase* configuration=0);
  FEOtsEthernetProgramInterface(const std::string& interfaceUID, const ConfigurationTree& theXDAQContextConfigTree,

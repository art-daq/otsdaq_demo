...
//========================================================================================================================
DemoDQMHistosConsumer::DemoDQMHistosConsumer(std::string supervisorApplicationUID, std::string bufferUID,
    ...
    : WorkLoop(processorUID),
      ...
      DQMFilePrefix_(
          theXDAQContextConfigTree.getNode(configurationPath).getNode("DQMFileNamePrefix").getValue<std::string>()),

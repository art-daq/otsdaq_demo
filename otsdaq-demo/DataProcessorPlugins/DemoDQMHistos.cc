...
//========================================================================================================================
DQMHistos::DQMHistos(std::string supervisorApplicationUID, std::string bufferUID, std::string processorUID)
...
//========================================================================================================================
DQMHistos::~DQMHistos(void)
{
}

//========================================================================================================================
void DQMHistos::book(const ConfigurationTree& theXDAQContextConfigTree, const std::string& configurationPath)
{
	__MOUT__ << "Booking start!" << std::endl;
	__MOUT__ << theXDAQContextConfigTree << std::endl;

	/*LORE SEPTEMBER 2016 MUST BE FIXED TO RUN AT MTEST!!!!
...
//========================================================================================================================
void DQMHistos::fill(std::string& buffer, std::map<std::string, std::string> header)
{
...
//========================================================================================================================
void DQMHistos::load(std::string fileName)
{

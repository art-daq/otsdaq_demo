...
ControlsOtsInterface::ControlsOtsInterface(const std::string& interfaceUID,
...
std::array<std::string, 4> ControlsOtsInterface::getCurrentValue(std::string Name) { return {"a", "b", "c", "d"}; }

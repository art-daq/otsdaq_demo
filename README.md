...
otsdaq-demo provides examples and templates of Art modules, Data Processor plugins, ROOT DQM modules, Front-End interfaces, Data Generators, standalone interface tests, _artdaq_ Overlays, Slow Controls Interface plugins, and a xdaq Supervisor.
